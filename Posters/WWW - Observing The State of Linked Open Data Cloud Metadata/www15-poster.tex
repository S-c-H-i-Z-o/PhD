...
\keywords{Metadata, Dataset Profile, LOD Cloud}
...
The results disccussed below are based on the LOD cloud containing 259 datasets at the time of writing this paper. The profiling process took around one and a half hour on a 2.6 Ghz Intel Core i7 processor with 16GB of DDR3 memory machine.\\
...
Three datasets (1.15\%) did not have a URL defined while 45 datasets (17.3\%) defined URLs were not accessible at the time writing this paper.\\
