...
\hypersetup
{
  ...
  colorlinks=true                                                                        , % hyperlinks color
  pdfpagelayout=SinglePage                                                               , % opening simple page
  pdffitwindow=true                                                                      , % pages ouvertes entierement dans toute la fenetre
  linkcolor=linkcol                                                                      , % color of internal hyperlinks
  citecolor=citecol                                                                      , % color of citations lines
