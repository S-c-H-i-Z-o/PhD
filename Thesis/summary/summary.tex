...
\title{Enabling Self-Service Data Provisioning Through Semantic Enrichment of Data}
...
\section{Towards A Complete Dataset Profile}\label{part1}

%%%%%%%%%%%%%%%%%%%%%%%%%
%%%  Dataset Profiles and Models  %%%
%%%%%%%%%%%%%%%%%%%%%%%%%

\subsection{Dataset Profiles and Models}\label{chapter:hdl}
...
\subsection{Objective Linked Data Quality Assessment}\label{chapter:data-quality}
...
\section{Towards Enriched Enterprise Data}\label{chapter:rubix}
...
\textbf{Matching Unnamed and Untyped Columns}\\ \\
...
\textbf{Handling Non-String Values}\\
...
\subsection{Semantic Social News Aggregation}\label{chapter:snarc}
...
In Chapter~\ref{chapter:rubix}, we presented an entity disambiguation API built on top of SAP HANA. This API is used in RUBIX, a framework we proposed to enable mashup of potentially noisy enterprise and external data.
