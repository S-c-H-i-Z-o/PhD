...
Section~\ref{section:installation_roomba} detail the instructions for installing and running the framework. The various steps are explained in detail below.
