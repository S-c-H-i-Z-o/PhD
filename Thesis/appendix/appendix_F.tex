...
\lstset{basicstyle=\scriptsize, backgroundcolor=\color{white}, frame=single, caption= {API call paramteres for entity enrichment}, label="API call paramteres for entity enrichment", captionpos=b}
...
\lstset{basicstyle=\scriptsize, backgroundcolor=\color{white}, frame=single, caption= {API call paramteres for entity disambiguation}, label="API call paramteres for entity disambiguation", captionpos=b}
...
\lstset{basicstyle=\scriptsize, backgroundcolor=\color{white}, frame=single, caption= {API call paramteres for schema matching}, captionpos=b, label="API call paramteres for schema matching"}
