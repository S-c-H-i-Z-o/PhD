...
\begin{figure}[!ht]
  \centering
    \includegraphics[scale=0.7]{architecture_document_handler.png}
...
\begin{figure}[!ht]
  \centering
    \includegraphics[scale=0.6]{architecture_data_parser.png}
...
\begin{wrapfigure}{r}{0.5\textwidth}
  \begin{center}
    \includegraphics[width=0.48\textwidth]{SNARC_UI.png}
  \end{center}
