...
\section{Data Profiling}\label{sec:dataProfiling}
...
Dataset profiles are collections of data describing the internal structure of the dataset. They are presented as a set of metadata in different formats such as JSON, XML and RDF.
...
\begin{figure}[ht!]
	\centering{
	\includegraphics[width=0.7\textwidth]{datahub.png}
	\caption{Datahub.io}
	\label{fig:datahub.io}
	}
\end{figure}
