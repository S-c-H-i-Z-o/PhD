...
In this section, we provide an overview of the processing steps for validating and generating dataset profiles. Figure 1 shows the main steps which are the following: (i) Data portal identification; (ii) dataset crawler; (iii) metadata extraction; (iv) instance and resource extraction; (v) profile validation and generation (vi) report generation. The various steps are explained in details below.
