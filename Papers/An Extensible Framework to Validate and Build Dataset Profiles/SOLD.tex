...
\textbf{Access information}: Information about the access and usage of the dataset. e.g. license information, license URL, dataset URL, etc.
...
The validation process identifies missing information and the ability to automatically correct them.
