...
\item \textbf{Access information}: Information about dataset access and usage (e.g., URL, license title and license URL). In addition to that models discussed above, there are several vocabularies designed to specify access right e.g., Linked Data Rights\footnote{\url{http://oeg-dev.dia.fi.upm.es/licensius/static/ldr/}}, The Open Digital Rights Language (ODRL)\footnote{\url{http://www.w3.org/ns/odrl/2/}}.
...
{\tinyv
\noindent\begin{longtable}{|p{1cm}|m{2.9cm}|m{2.4cm}|m{2.6cm}|p{3.8cm}|m{3.8cm}|m{6.5cm}|m{2.5cm}|}
