...
\cline{3-4}
 &  & QI.17 & Existence of queryable endpoints that respond to direct queries\tabularnewline
\hline
\hline
...
{\bf Provenance-based Approaches}\\
...
We notice that there is a plethora of tools that automatically checks the quality of  information. These tools are either syntactic checkers or statistical profiling tools covering the objective indicators.
...
\section{An Extensible Objective Quality Assessment Tool}
