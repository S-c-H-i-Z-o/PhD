...
\multirow{9}{*}{Completeness}
 & \multirow{6}{*}{Dataset Level} & QI.5 & Existence of supporting structured metadata  \cite{Hogan2010}\tabularnewline
\cline{3-4}
...
\hline
\hline
\multirow{9}{*}{Correctness} & \multirow{4}{*}{Entity Level} & QI.22 & Absence of missing or empty labels \cite{Acosta2013}\cite{Mader2012}\tabularnewline
\cline{3-4}
...
\cline{2-4}
 & \multirow{2}{*}{Dataset Level} & QI.26 & Includes the correct MIME-type for the content  \cite{Hogan2010}\tabularnewline
\cline{3-4}
 &  & QI.27 & Checked against syntactic errors \cite{Hogan2010}\tabularnewline
\cline{2-4}
 & \multirow{1}{*}{Links Level} & QI.27 & Absence of syntactic errors  \cite{Suominen2013}\tabularnewline
\cline{2-4}
...
\hline
\hline
\multirow{2}{*}{Security} & \multirow{2}{*}{Dataset Level} & QI.34 & Uses login credentials to restrict access \cite{Framework2012}\tabularnewline
\cline{3-4}
...
\hline
\hline
\multirow{3}{*}{Licensing} & \multirow{3}{*}{Dataset Level} & QI.38 & Existence of human and machine readable license information \cite{Hogan:2012:ESL:2263498.2264570}\tabularnewline
\cline{3-4}
...
\hline
\hline
\multirow{4}{*}{Comprehensibility} & \multirow{4}{*}{Dataset Level} & QI.41 & Existence of at least one exemplary URI \cite{Framework2012}\tabularnewline
\cline{3-4}
