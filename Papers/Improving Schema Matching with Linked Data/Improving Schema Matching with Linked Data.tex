...
\textbf{Table 3. Similarity Scores Using the AMC Default Matching Algorithms+  the PPMCC Similarity Method}

372213305The Spearman Similarity algorithm combined with the AMC default matchers produces the results shown in Table 4.372213305ttroncy372213305-2028243878Here, there are 10 matches, we lost one ... which one? Why?
...
\textbf{Table 4. Similarity Scores Using the AMC Default Matching Algorithms + Spearman Similarity Method}
...
\textbf{Table 5. Similarity Scores Using the Combination of Cosine, PPMCC and AMC's defaults}
...
Now, we will try and group all the mentioned algorithms. The combination of all Similarity algorithms with the AMC default matchers produces the results shown in Table 6.
