...
We ran our tool on two CAKN-based data portals, The LOD cloud group hosted on Datahub and the Amsterdam Open Data portal\footnote{http://data.amsterdamopendata.nl/}. At the time of running this tool, the CKAN API returned 259 datasets for the tag name \"lodcloud\" with a total of 1068 resources. Amsterdam data portal contained 172 datasets with a total of 480 resources.
